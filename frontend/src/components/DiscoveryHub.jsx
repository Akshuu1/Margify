    ...
    return (
        <div ref={hubRef} className="w-full mb-10 space-y-4 px-1">
            <div className="flex flex-col xl:flex-row gap-6">
                {/* Pro-Balanced Weather Dashboard (2/3) */}
                ...
                {/* Pro-Balanced Experience Dashboard (1/3) */}
                    ...
                    <div className="flex flex-col gap-3.5 mt-auto relative z-10">
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <div className="p-2.5 bg-white/5 rounded-xl group-hover/btn:bg-indigo-500/10 transition-colors border border-white/10">
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <div className="p-2.5 bg-white/5 rounded-xl group-hover/btn:bg-orange-500/10 transition-colors border border-white/10">
                            ...
                            <div className={`w-2 h-2 rounded-full ${hasStops ? 'bg-orange-500 animate-pulse' : 'bg-white/10'}`}></div>
                        </button>
                    </div>
                </div>
            </div>
            {/* Visual Divider to maintain "Airy" Whitespace below */}
