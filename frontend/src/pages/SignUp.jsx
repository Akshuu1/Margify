  ...
  return (
    <div style={{ fontFamily: "Space Grotesk" }} className="flex justify-center items-center text-center px-4 min-h-screen w-screen">
      <div className="text-[#E0E0E0] w-full max-w-md sm:max-w-lg">
        <h1 className="font-[Kiona-Regular] text-[3.5rem] sm:text-[5rem] md:text-[7rem]">Margify</h1>
        <h2 className="text-[0.9rem] sm:text-[1rem] mb-4 -mt-2">Find Your Best Path</h2>
        <div className="bg-[#111111]/70 p-6 sm:p-8 rounded-3xl w-full">
          <form onSubmit={handlSignup} className="space-y-4">
            ...
            <button type="submit" className="bg-[#FFCB74] mt-2 w-full text-[#111111] rounded-xl py-2 text-sm font-medium hover:opacity-90 transition">Create your account</button>
          </form>
