        ...
        <div className="text-[#E0E0E0]">
            ...
            <div className="bg-[#111111]/70 p-[2vw] leading-10 rounded-3xl w-[35rem] ">
                <form>
                    ...
                    <a href="/" className="flex items-start text-[.7rem] ml-[8px]" >Forgot your password ?</a>
                    <button type='submit' className="bg-[#FFCB74] w-full text-[#111111] rounded-xl p-[.3rem] ">Find your path</button>
                </form>
            ...
            <a href="/signup" className="text-[.7rem]">Don't have an account ?</a>
            </div>
        </div>
    </div>
    )
