      ...
      <div className="text-[#E0E0E0] w-full max-w-md sm:max-w-lg">
        ...
        <div className="bg-[#111111]/70 p-6 sm:p-8 rounded-3xl w-full">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Link to="/forgot-password" size="sm" className="text-[0.7rem] ml-2 text-left block opacity-80 hover:text-[#FFCB74] transition-colors">Forgot your password?</Link>
            <button type="submit" className="bg-[#FFCB74] w-full text-[#111111] rounded-xl py-2 text-sm font-medium hover:opacity-90 transition">Find your path</button>
          </form>
